...
async def async_setup_entry(
    ...
    num_leds = config_entry.data.get(CONF_NUM_LEDS, DEFAULT_NUM_LEDS)
    num_sections = config_entry.data.get(CONF_NUM_SECTIONS, DEFAULT_NUM_SECTIONS)
    ...
    strip = GoveeRazerStrip(
        hass, name, host, port, num_leds, num_sections, update_interval
    )
